    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                <form action="./database-process/patientController.php" method="POST">
                            <div class="row">
                                <div class="col-sm-6">
								...
								<div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <!-- <div class="cal-icon">
                                            <input type="text" class="form-control datetimepicker" name="patient_age"> -->
								...
								<div class="col-sm-12">
									<div class="row">
										...
										<div class="col-sm-6 col-md-6 col-lg-3">
											<div class="form-group">
												<label>Country</label>
												<select value class="form-control select" name="country">
													<option value="Pakisatn">Pakisatn</option>
										...
										<div class="col-sm-6 col-md-6 col-lg-3">
											<div class="form-group">
												...
												<select class="form-control select" name="state">
													...
													<option value="Balochisatn">Balochisatn</option>
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="patient_active" value="active" name="status" checked>
									<label class="form-check-label" for="patient_active">
									Active
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" id="patient_inactive" value="inactive" name="status">
