...
<head>
    ...
    <title>Hyderabad_Hospital, Sind</title>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="./database-process/DoctorController.php" method="POST">
                            <div class="row">
                                <div class="col-sm-6">
										...
										<div class="col-sm-6 col-md-6 col-lg-3">
											<div class="form-group">
												...
												<select name="state" class="form-control select">
													<option value="Calfornio">California</option>
							...
							<div class="form-group">
                                ...
                                <textarea class="form-control" name="short_biography" rows="3" cols="30"></textarea>
                            </div>
